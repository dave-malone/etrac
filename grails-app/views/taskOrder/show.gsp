...
<html>
    ...
    <body>
		...
		<table>
			<tbody>
				<tr>
					<td valign="top"><g:message code="taskOrder.dateCreated.label" default="Date Posted" /></td>                            
					<td valign="top"><g:formatDate date="${taskOrderInstance?.dateCreated}" format="MMM d, yyyy 'at' H:mmz"/></td>                            
				</tr>				
				<tr>
				    <td valign="top"><g:message code="taskOrder.dueDate.label" default="Due Date" /></td>                            
					<td valign="top"><g:formatDate date="${taskOrderInstance?.dueDate}" format="MMM d, yyyy 'at' H:mmz"/></td>                            
				</tr>
				
				<g:if test="${taskOrderInstance?.status in ['Completed', 'Approved', 'Invoiced', 'Certified']}">
					<tr>
					    <td valign="top"><g:message code="taskOrder.dateCompleted.label" default="Date Completed" /></td>	                            
						<td valign="top"><g:formatDate date="${taskOrderInstance?.dateCompleted}" format="MMM d, yyyy 'at' H:mmz" /></td>	                            
					</tr>
				</g:if>	                    
				<g:if test="${taskOrderInstance?.status in ['Approved', 'Invoiced', 'Certified']}">
					<tr>
						<td valign="top"><g:message code="taskOrder.dateApproved.label" default="Date Approved" /></td>	                            
						<td valign="top"><g:formatDate date="${taskOrderInstance?.dateApproved}" format="MMM d, yyyy 'at' H:mmz" /></td>	                            
					</tr>                 
				</g:if>                    
				<g:if test="${taskOrderInstance?.status in ['Invoiced', 'Certified']}">
					<tr>
						<td valign="top"><g:message code="taskOrder.dateInvoiced.label" default="Date Invoiced" /></td>	                            
						<td valign="top"><g:formatDate date="${taskOrderInstance?.dateInvoiced}" format="MMM d, yyyy 'at' H:mmz" /></td>	                            
					</tr>
				</g:if>
				<g:if test="${taskOrderInstance?.status == 'Certified'}">
					<tr>
						<td valign="top"><g:message code="taskOrder.dateCertified.label" default="Date Certified" /></td>	                            
						<td valign="top"><g:formatDate date="${taskOrderInstance?.dateCertified}" format="MMM d, yyyy 'at' H:mmz" /></td>	                            
					</tr>
				</g:if>
				<g:if test="${taskOrderInstance?.status == 'Canceled'}">
					<tr>
						<td valign="top"><g:message code="taskOrder.dateCanceled.label" default="Date Canceled" /></td>	                            
						<td valign="top"><g:formatDate date="${taskOrderInstance?.dateCanceled}" format="MMM d, yyyy 'at' H:mmz" /></td>	                            
					</tr>
				</g:if>
                      
				<tr>
					<td valign="top"><g:message code="taskOrder.createdBy.label" default="Posted By" /></td>                            
					<td valign="top"><g:link controller="user" action="show" id="${taskOrderInstance?.createdBy?.id}">${taskOrderInstance?.createdBy?.encodeAsHTML()}</g:link></td>                            
				</tr>				
				<tr>
				    <td valign="top"><g:message code="taskOrder.contractNumber.label" default="Contract Number" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "contractNumber")}</td>                            
				</tr>				
				<tr>
				    <td valign="top"><g:message code="taskOrder.vaInternalNumber.label" default="VA Internal PO Number" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "vaInternalNumber").replace("\n", "<br />")}</td>                            
				</tr>
				<tr>
				    <td valign="top"><g:message code="taskOrder.priority.label" default="Priority" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "priority")}</td>                            
				</tr>				
				<tr>
					<td valign="top"><g:message code="taskOrder.room.label" default="Room" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "room")}</td>                            
				</tr>				
				<tr>
					<td valign="top"><g:message code="taskOrder.closet.label" default="Closet" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "closet")}</td>                            
				</tr>				
				<tr>
					<td valign="top"><g:message code="taskOrder.installationType.label" default="Installation Type" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "installationType")}</td>                            
				</tr>				
				<tr>
				    <td valign="top"><g:message code="taskOrder.panelType.label" default="Panel Type" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "panelType")}</td>                            
				</tr>				
				<tr>
				    <td valign="top"><g:message code="taskOrder.numberOfCables.label" default="Number Of Cables" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "numberOfCables")}</td>                            
				</tr>				
				<tr>
				    <td valign="top"><g:message code="taskOrder.numberOfLocations.label" default="Number Of Locations" /></td>                            
					<td valign="top">${fieldValue(bean: taskOrderInstance, field: "numberOfLocations")}</td>                            
				</tr>                  
				<tr>
					<td valign="top"><g:message code="taskOrder.existingPatchPanel.label" default="Existing Patch Panel" /></td>                            
					<td valign="top"><g:formatBoolean boolean="${taskOrderInstance?.existingPatchPanel}" true="Yes" false="No" /></td>                            
				</tr>				
				<tr>
					<td valign="top"><g:message code="taskOrder.existingRack.label" default="Existing Rack" /></td>                            
					<td valign="top"><g:formatBoolean boolean="${taskOrderInstance?.existingRack}" true="Yes" false="No" /></td>                            
				</tr> 
