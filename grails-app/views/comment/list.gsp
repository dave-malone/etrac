                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="comment.createdBy.label" default="Created By" /></th>
                        
                            <th><g:message code="comment.updatedBy.label" default="Updated By" /></th>
                    ...
                    <g:each in="${commentInstanceList}" status="i" var="commentInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: commentInstance, field: "updatedBy")}</td>
