            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.createdBy.label" default="Created By" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.updatedBy.label" default="Updated By" /></td>
                            
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${commentInstance?.updatedBy?.id}">${commentInstance?.updatedBy?.encodeAsHTML()}</g:link></td>
